            ...
            <div className={styles.timer}>
                ...
                <div className={styles.timerClock}>
                    ...
                    <div className={styles.PlayBtn}>
                        ...
                        <div className={styles.Play}>{props.play ? <FontAwesomeIcon onClick={onClickPlay} icon="fa-solid fa-play" /> : <FontAwesomeIcon onClick={onClickPause} icon="fa-solid fa-pause" />}</div>
