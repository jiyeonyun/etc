...
const TrackerCycle = ({popup,setPopup}) => {
        const onClick = ()=>{
            setPopup(!popup);
        }
        const onOk = ()=>{
    ...
    return(
        <div className={`${popup?styles.task_tracker_popup:styles.task_tracker}`}>
            ...
            <div className={styles.task_trackers}>
                ...
                <Timer popup={popup} setPopup={setPopup} focusHr={focusHr} focusMin={focusMin}
                BreakHr={BreakHr} BreakMin={BreakMin} cylceTime={cylceTime} 
                />
                <TaskTracker/>
            </div>
        </div>
