      ...
      <section>
        <div className={styles.scrollContainer}>
          <div className={styles.stickyCopy}>
            <div
              className={styles.copyFirst}
              style={scrollY >= 150 ? { transform: 'translate(0px, -300px)', opacity: '0' } : {}}
            >
              <h1 className={styles.title}>1번스크롤</h1>
            </div>
            <div
              className={styles.copySecond}
              style={scrollY <= 150 ? { transform: 'translate(0px, 151px)', opacity: '0' } : {}}
            >
